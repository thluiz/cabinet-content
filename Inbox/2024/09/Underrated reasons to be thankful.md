---
created: 2024-09-06T13:05:21 (UTC -03:00)
tags: []
source: https://dynomight.net/thanks/
author: dynomight
---
...
20.  That Ramanujan existed, which means that humans not _that_ different from you or me can have capabilities that seem impossible, which is a hint that—possibly with a little help—human potential might be much higher than it now seems.
...
22.  That it’s even possible to develop technologies to produce huge amounts of energy without emitting carbon and we happen to have developed them at a time where we at least _could_ avoid the most extreme climate change scenarios with minimal impact on our lifestyles.
...
27.  That the homeostatic theory of drug tolerance isn’t a 100% perfect law, which means that we aren’t _entirely_ stuck with our bodies operating according to their own whims all the time.
...
30.  That other animals have more cone cells than humans, e.g. [birds with four](https://en.wikipedia.org/wiki/Bird_vision#Light_perception) and [shrimp with _up to 16_](https://www.theatlantic.com/science/archive/2018/04/mantis-shrimp-eye-camera/557195/), and so probably see colors we can’t even conceive of which, yeah, that limitation of our minds is frustrating, but it also hints that there are huge unseen dark continents of qualia lurking out there which someday we might find a way to visit.
